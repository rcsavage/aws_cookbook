...
execute "digitaldreams-rpm-check: nokogiri-1.6.2.1-1" do
  command "rpm -ivh --nodeps --force http://yumrepo.digitaldreamsjira.com/common/rubygem-nokogiri-1.6.2.1-1.x86_64.rpm"
  not_if "rpm -qa | grep -q 'rubygem-nokogiri-1.6.2.1-1.x86_64'"
  action :nothing
end.run_action(:run)
execute "digitaldreams-rpm-check: mini_portile-0.6.0-1" do
  command "rpm -ivh --nodeps --force http://yumrepo.digitaldreamsjira.com/common/rubygem-mini_portile-0.6.0-1.noarch.rpm"
  not_if "rpm -qa | grep -q 'rubygem-mini_portile-0.6.0-1.noarch'"
  action :nothing
end.run_action(:run)
execute "digitaldreams-rpm-check: aws-sdk-1.42.0-1" do
  command "rpm -ivh --nodeps --force http://yumrepo.digitaldreamsjira.com/common/rubygem-aws-sdk-1.42.0-1.noarch.rpm"
